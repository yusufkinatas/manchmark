...
export const user = {
  ...
  updateHighscore: (score, highScoreName) => {
    return new Promise((resolve, reject) => {
      ...
      if (_user.isConnected) {
        api
          .updateHighscores(user.get().authToken, { [highScoreName]: score })
          .then((res) => {
            resolve()
          })
          .catch((err) => {
  ...
  getRank: (game) => {
    return new Promise((resolve, reject) => {
      api
        .getRank(_user.nickname, game)
        .then((res) => {
          user.set(
            { ranks: { ..._user.ranks, userCount: res.data.userCount, [game]: res.data.rank } },
            true
          )
          resolve(res.data)
        })
  ...
  getFriendHighscores: () => {
    return new Promise((resolve, reject) => {
      api
        .getFriendLeaderboard(_user.authToken)
        .then((res) => {
  ...
  changeNickname: (nickname) => {
    return new Promise((resolve, reject) => {
      api
        .changeNickname(_user.authToken, nickname)
        .then((res) => {
  ...
  changePhoneNumber: (facebookAuthCode) => {
    return new Promise((resolve, reject) => {
      api
        .changePhoneNumber(_user.authToken, facebookAuthCode)
        .then((res) => {
  ...
  updateStatistics: () => {
    return new Promise((resolve, reject) => {
      api
        .updateStatistics(_user.authToken, _user.statistics)
        .then((res) => {
          resolve()
        })
        .catch((err) => reject(err))
