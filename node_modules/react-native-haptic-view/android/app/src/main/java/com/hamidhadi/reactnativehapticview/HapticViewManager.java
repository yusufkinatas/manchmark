        ...
        switch(commandId) {
            case COMMAND_PERFORM_HAPTIC:
                ...
                try {
                    ...
                    if(args.size() == 2) {
                        flag = args.getString(1);
                    }
                    
                    int feedbackConstantFromArgsValue = HapticFeedbackConstants.class.getField(feedbackConstantFromArgs).getInt(null);
                    int flagValue = HapticFeedbackConstants.class.getField(flag).getInt(null);
                    
                    if(flag != null && !flag.isEmpty()) {
                        root.performHapticFeedback(feedbackConstantFromArgsValue, flagValue);
                    }
                    else {
