        ...
        <View style={{ alignItems: 'center' }}>
          ...
          <TouchableOpacity
            style={{
              ...
              borderRadius: 50,
              elevation: 5,
              backgroundColor: this.state.soundEnabled ? colors.primary : colors.failure,
              alignItems: 'center',
          ...
          >
            <Icon
              name={this.state.soundEnabled ? 'volume-2' : 'volume-x'}
        ...
        <View style={{ alignItems: 'center', marginTop: 10 }}>
          ...
          <TouchableOpacity
            style={{
              ...
              borderRadius: 50,
              elevation: 5,
              backgroundColor: this.state.hapticEnabled ? colors.primary : colors.failure,
              alignItems: 'center',
              justifyContent: 'center',
              marginTop: 10,
            }}
